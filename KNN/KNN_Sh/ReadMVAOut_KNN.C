...
void ReadMVAOut_KNN() {
  ...
  in_file_names.push_back("/afs/cern.ch/work/w/wshi/public/TMVA_2017/TMVA/EMTFPtAssign2017/PtRegression_v0_KNN.root");
  ...
  //std::cout << "\n******* Leaving the test event loop *******" << std::endl;
   ...
   //     std::cout << "bin: " <<bin<<", count: "<<count[bin]<<", KNN_pass: "<<pass_count[bin]<<", EMTF_pass: "<<EMTF_pass_count[bin]<< std::endl;
    ...
    TFile myPlot("/afs/cern.ch/work/w/wshi/public/TMVA_2017/TMVA/EMTFPtAssign2017/Output_v0_KNN.root","RECREATE");
