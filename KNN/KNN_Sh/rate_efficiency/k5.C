...
//=========  (Fri Mar 17 16:32:08 2017) by ROOT version6.06/02
   ...
   76,
   66};
   TGraph *graph = new TGraph(59,Graph_fx113,Graph_fy113);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph113 = new TH1F("Graph_Graph113","Graph",100,0,104.4);
   Graph_Graph113->SetMinimum(0);
   Graph_Graph113->SetMaximum(686192.1);
   ...
   52,
   52};
   graph = new TGraph(59,Graph_fx114,Graph_fy114);
   graph->SetName("Graph");
   graph->SetTitle("Graph");
   graph->SetFillColor(1);
   graph->SetMarkerStyle(21);
   
   TH1F *Graph_Graph114 = new TH1F("Graph_Graph114","Graph",100,0,104.4);
   Graph_Graph114->SetMinimum(0);
   Graph_Graph114->SetMaximum(686193.5);
