...
//=========  (Fri Mar 17 14:48:17 2017) by ROOT version6.06/02
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",329,94,1347,829);
   Canvas_1->Range(-16.57695,-82123.04,112.6731,736139.1);
   ...
   50,
   48};
   TGraph *graph = new TGraph(59,Graph_fx71,Graph_fy71);
   graph->SetName("Graph");
   ...
   Graph_Graph71->SetMaximum(686193.9);
   ...
   Graph_Graph72->SetMaximum(686193.5);
