...
//=========  (Fri Mar 17 15:13:50 2017) by ROOT version6.06/02
   ...
   55,
   59};
   TGraph *graph = new TGraph(59,Graph_fx91,Graph_fy91);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph91 = new TH1F("Graph_Graph91","Graph",100,0,104.4);
   Graph_Graph91->SetMinimum(0);
   Graph_Graph91->SetMaximum(686193.2);
   ...
   52,
   52};
   graph = new TGraph(59,Graph_fx92,Graph_fy92);
   graph->SetName("Graph");
   graph->SetTitle("Graph");
   graph->SetFillColor(1);
   graph->SetMarkerStyle(21);
   
   TH1F *Graph_Graph92 = new TH1F("Graph_Graph92","Graph",100,0,104.4);
   Graph_Graph92->SetMinimum(0);
   Graph_Graph92->SetMaximum(686193.5);
