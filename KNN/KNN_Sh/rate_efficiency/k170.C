...
//=========  (Fri Mar 17 13:57:51 2017) by ROOT version6.06/02
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",329,94,1347,829);
   Canvas_1->Range(-16.625,-81875.73,112.625,736881.5);
   ...
   Graph_Graph47->SetMaximum(686194.5);
   ...
   Graph_Graph48->SetMaximum(686193.5);
