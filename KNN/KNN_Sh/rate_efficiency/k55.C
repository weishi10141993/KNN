...
//=========  (Fri Mar 17 13:16:23 2017) by ROOT version6.06/02
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",329,94,1347,829);
   Canvas_1->Range(-16.625,-81875.7,112.625,736881.2);
   ...
   Graph_Graph13->SetMaximum(686194.1);
   ...
   Graph_Graph14->SetMaximum(686193.5);
