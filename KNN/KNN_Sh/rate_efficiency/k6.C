...
//=========  (Fri Mar 17 16:32:25 2017) by ROOT version6.06/02
   ...
   75,
   62};
   TGraph *graph = new TGraph(59,Graph_fx115,Graph_fy115);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph115 = new TH1F("Graph_Graph115","Graph",100,0,104.4);
   Graph_Graph115->SetMinimum(0);
   Graph_Graph115->SetMaximum(686192.5);
   ...
   52,
   52};
   graph = new TGraph(59,Graph_fx116,Graph_fy116);
   graph->SetName("Graph");
   graph->SetTitle("Graph");
   graph->SetFillColor(1);
   graph->SetMarkerStyle(21);
   
   TH1F *Graph_Graph116 = new TH1F("Graph_Graph116","Graph",100,0,104.4);
   Graph_Graph116->SetMinimum(0);
   Graph_Graph116->SetMaximum(686193.5);
