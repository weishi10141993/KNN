...
//=========  (Fri Mar 17 13:56:28 2017) by ROOT version6.06/02
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",329,94,1347,829);
   Canvas_1->Range(-16.625,-81875.69,112.625,736881.1);
   ...
   Graph_Graph39->SetMaximum(686193.8);
   ...
   Graph_Graph40->SetMaximum(686193.5);
