...
//=========  (Fri Mar 17 16:31:49 2017) by ROOT version6.06/02
   ...
   99,
   77};
   TGraph *graph = new TGraph(59,Graph_fx111,Graph_fy111);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph111 = new TH1F("Graph_Graph111","Graph",100,0,104.4);
   Graph_Graph111->SetMinimum(0);
   Graph_Graph111->SetMaximum(686191);
   ...
   52,
   52};
   graph = new TGraph(59,Graph_fx112,Graph_fy112);
   graph->SetName("Graph");
   graph->SetTitle("Graph");
   graph->SetFillColor(1);
   graph->SetMarkerStyle(21);
   
   TH1F *Graph_Graph112 = new TH1F("Graph_Graph112","Graph",100,0,104.4);
   Graph_Graph112->SetMinimum(0);
   Graph_Graph112->SetMaximum(686193.5);
