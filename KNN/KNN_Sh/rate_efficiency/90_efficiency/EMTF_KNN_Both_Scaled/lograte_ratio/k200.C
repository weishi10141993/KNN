...
//=========  (Sat Mar 11 20:43:00 2017) by ROOT version6.06/02
   ...
   Graph_Graph45->SetMinimum(1.298821);
   Graph_Graph45->SetMaximum(6.203806);
   ...
   Graph_Graph46->SetMinimum(1.308098);
   Graph_Graph46->SetMaximum(6.202963);
