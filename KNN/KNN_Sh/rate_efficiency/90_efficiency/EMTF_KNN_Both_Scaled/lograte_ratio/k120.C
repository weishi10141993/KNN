...
//=========  (Sat Mar 11 20:39:45 2017) by ROOT version6.06/02
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",260,94,1416,829);
   Canvas_1->Range(-16.625,0.9205346,112.625,6.564719);
   ...
   1.690196,
   1.690196};
   TGraph *graph = new TGraph(59,Graph_fx29,Graph_fy29);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph29 = new TH1F("Graph_Graph29","Graph",100,0,104.4);
   Graph_Graph29->SetMinimum(1.27971);
   Graph_Graph29->SetMaximum(6.205543);
   ...
   TH1F *Graph_Graph30 = new TH1F("Graph_Graph30","Graph",100,0,104.4);
   Graph_Graph30->SetMinimum(1.308098);
   Graph_Graph30->SetMaximum(6.202963);
