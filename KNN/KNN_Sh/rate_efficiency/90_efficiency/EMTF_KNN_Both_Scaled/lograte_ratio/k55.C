...
//=========  (Sat Mar 11 21:25:21 2017) by ROOT version6.06/02
   ...
   Graph_Graph49->SetMinimum(1.249528);
   Graph_Graph49->SetMaximum(6.208287);
   ...
   Graph_Graph50->SetMinimum(1.308098);
   Graph_Graph50->SetMaximum(6.202963);
