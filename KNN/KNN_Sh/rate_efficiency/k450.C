...
//=========  (Fri Mar 17 15:14:10 2017) by ROOT version6.06/02
   ...
   53,
   58};
   TGraph *graph = new TGraph(59,Graph_fx93,Graph_fy93);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph93 = new TH1F("Graph_Graph93","Graph",100,0,104.4);
   Graph_Graph93->SetMinimum(0);
   Graph_Graph93->SetMaximum(686193.4);
   ...
   52,
   52};
   graph = new TGraph(59,Graph_fx94,Graph_fy94);
   graph->SetName("Graph");
   graph->SetTitle("Graph");
   graph->SetFillColor(1);
   graph->SetMarkerStyle(21);
   
   TH1F *Graph_Graph94 = new TH1F("Graph_Graph94","Graph",100,0,104.4);
   Graph_Graph94->SetMinimum(0);
   Graph_Graph94->SetMaximum(686193.5);
