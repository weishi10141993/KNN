...
//=========  (Fri Mar 17 16:33:10 2017) by ROOT version6.06/02
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",329,94,1347,829);
   Canvas_1->Range(-16.57695,-82123.08,112.6731,736139.4);
   ...
   53,
   42};
   TGraph *graph = new TGraph(59,Graph_fx121,Graph_fy121);
   graph->SetName("Graph");
   ...
   TH1F *Graph_Graph121 = new TH1F("Graph_Graph121","Graph",100,0,104.4);
   Graph_Graph121->SetMinimum(0);
   Graph_Graph121->SetMaximum(686194.5);
   ...
   52,
   52};
   graph = new TGraph(59,Graph_fx122,Graph_fy122);
   graph->SetName("Graph");
   graph->SetTitle("Graph");
   graph->SetFillColor(1);
   graph->SetMarkerStyle(21);
   
   TH1F *Graph_Graph122 = new TH1F("Graph_Graph122","Graph",100,0,104.4);
   Graph_Graph122->SetMinimum(0);
   Graph_Graph122->SetMaximum(686193.5);
