...
//=========  (Fri Mar 17 13:58:09 2017) by ROOT version6.06/02
   ...
   47,
   47};
   TGraph *graph = new TGraph(59,Graph_fx49,Graph_fy49);
   graph->SetName("Graph");
   ...
   Graph_Graph49->SetMaximum(686194);
   ...
   Graph_Graph50->SetMaximum(686193.5);
