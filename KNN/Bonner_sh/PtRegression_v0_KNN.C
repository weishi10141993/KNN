...
void PtRegression_v0_KNN( TString myMethodList = "" )
{
   ...
   fnames.push_back("/home/ws13/TMVA/TMVA/EMTFPtAssign2017/mix/EMTF_MC_NTuple_SingleMu_noRPC_combined.root");
  ...
  // in_vars.push_back( MVA_var( "outSt",     "Outlier station",   "int", 'I', -88 ) );
   ...
   if (Use["KNN"])
      factory->BookMethod( dataloader,  TMVA::Types::kKNN, "KNN",
                           "!H:!V:nkNN=10:ScaleFrac=0.8:SigmaFact=1.0:Kernel=Gaus:UseKernel=T:UseWeight=T:!Trim" );
